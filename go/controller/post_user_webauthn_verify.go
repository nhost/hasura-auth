...
func (ctrl *Controller) PostUserWebauthnVerify( //nolint:ireturn
	ctx context.Context,
	request api.PostUserWebauthnVerifyRequestObject,
) (api.PostUserWebauthnVerifyResponseObject, error) {
	...
	return api.PostUserWebauthnVerify200JSONResponse{

...
func TestPostElevateWebauthn(t *testing.T) {
	t.Parallel()
	...
	cases := []testRequest[api.PostElevateWebauthnRequestObject, api.PostElevateWebauthnResponseObject]{
		{
